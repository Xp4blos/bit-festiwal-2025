...
export default function AuthPage() {
  ...
  const handleRegistration = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://kokos-api.grayflower-7f624026.polandcentral.azurecontainerapps.io/api/Users",
        {
          method: "POST",
          headers: {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://kokos-api.grayflower-7f624026.polandcentral.azurecontainerapps.io/api/Users/bylogin",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
